...
/* package relation-tool-0.1.0.0 */
#define VERSION_relation_tool "0.1.0.0"
#define MIN_VERSION_relation_tool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_PACKAGE_KEY "relat_DaZPwtpGOYDG2TMuXLK0RY"
